...
- [x] (amended 2026-08-30) Forward Better Auth's refreshed session cookie from protected API requests and prove that activity after `updateAge` advances both the database session expiry and the browser cookie lifetime.
