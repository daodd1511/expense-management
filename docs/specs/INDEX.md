...
|------|--------|--------|------|-------------|
| [transaction-running-balance](transaction-running-balance/PLAN.md) | In progress | 2/3 | — | Produced via /grill-me interview. All decisions below were explicitly confirmed; do not… |
