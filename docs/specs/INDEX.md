...
|------|--------|--------|------|-------------|
| [pwa-update-prompt](pwa-update-prompt/PLAN.md) | In progress | 1/2 | — | Produced via /grill-with-docs interview. All decisions below were explicitly confirmed; do not… |
