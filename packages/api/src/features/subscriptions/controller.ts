...
export async function createSubscription(userId: string, input: Parameters<typeof service.createSubscription>[1]) {
...
export async function updateSubscription(userId: string, id: string | undefined, input: Parameters<typeof service.updateSubscription>[2]) {
