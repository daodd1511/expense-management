...
describe('reportsRouter', () => {
  ...
  it('returns monthly income vs expense report with transfer excluded', async () => {
    ...
    const response = await makeApp().request('/reports/income-expense?from=2026-07-01&to=2026-08-31')
  ...
  it('rejects an inverted date range', async () => {
    ...
    const response = await makeApp().request('/reports/income-expense?from=2026-08-31&to=2026-07-01')
