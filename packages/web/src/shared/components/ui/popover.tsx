...
function PopoverPositioner({
  ...
  return (
    <PopoverPrimitive.Positioner className={cn("z-50", className)} sideOffset={6} {...props} />
  );
}
...
export { PopoverRoot as Popover, PopoverTrigger, PopoverPortal, PopoverPositioner, PopoverPopup };
